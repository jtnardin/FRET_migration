...
function mean_cell_data_fitting_pred(l,m,pred_ind,stat_model)
...
%     stat_model = 'autor';
    ...
    save(['/scratch/summit/jona8898/FRET_fitting/FRET_interp_est_well_' num2str(well) '_' num2str(l) '_' name_save '_pred_' num2str(pred_ind) '.mat' ],...
